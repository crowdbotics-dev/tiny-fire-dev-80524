"""
Django settings for tiny_fire_dev_80524 project.
...
ROOT_URLCONF = 'tiny_fire_dev_80524.urls'
...
WSGI_APPLICATION = 'tiny_fire_dev_80524.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tiny_fire_dev_80524 API",
    "DESCRIPTION": "API documentation for tiny_fire_dev_80524 App",
    "VERSION": "v1",
}
